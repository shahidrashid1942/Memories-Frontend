            ...
            <div className='space-y-2 p-8 shadow-xl rounded-lg'>
                <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center space-y-2'>
                    <label className="input input-bordered flex items-center gap-2">
                        ...
                        <input type="text" className="grow" placeholder="Username" required minLength={3} onChange={handleChange} name='username' value={input.username} />
                    </label>
                    <label className="input input-bordered flex items-center gap-2">
                    ...
                    <label className="input input-bordered flex items-center gap-2">
                        ...
                        <input type="password" className="grow" placeholder='Password' required minLength={8} onChange={handleChange} name="password" value={input.password} />
                    </label>
                    <button className='input input-bordered rounded px-1 py-2 w-full max-w-xs hover:btn-outline' type="submit">Submit</button>
                </form>
                <p className='text-sm text-center'>Alredy have an account? <Link className={props.dark ? `underline decoration-white` : `underline decoration-black`} to="/login">Login</Link></p>
            </div>
        </div>
    )
}
